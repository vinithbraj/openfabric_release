...
Gateway cwd, scheduled events, request traces, plan caches, and computation
caches are useful locally but should not be reused as shared capability data
without a separate curation step.
